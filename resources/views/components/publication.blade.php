            ...
            <div class="timeline-details">
                ...
                <div class="card-block user-box p-0">
                    ...
                    <span class="float-end">
                        @if (!$isOwner)
                            <form action="/{{ session('user')->nom_usu }}/rt/{{ $publication->id_pub }}" method="POST"
                                class="btn btn-primary btn-sm waves-effect waves-light">
                                @csrf
                                <button type="submit" style="all: unset">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" class="mr-10"
                        ...
                        @else
                            <form action="/{{ session('user')->nom_usu }}/publication/{{ $publication->id_pub }}/delete" method="POST"
