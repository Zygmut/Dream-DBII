<nav class="navbar navbar-dark navbar-expand-lg bg-dark rounded sticky-top">
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="navbarText">
            ...
            <span>
                <a href="/{{ session('user')->nom_usu }}/profile" class="text-white nav-link "
                    style="width: 50px; height:50px">

                    <img @if (session('user')->foto_perfil == null) src="/img/default_profile.jpg"
                                @else
                                src="data:image/png;base64,{{ base64_encode(session('user')->foto_perfil) }}" @endif
                        alt="Generic placeholder image" class="rounded-4"
